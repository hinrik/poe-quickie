...
stdin will then be shut down. B<Note:> no processing will be done on the data
...
This L<kills|POE::Wheel::Run/kill> all programs which POE::Quickie is
managing for your session. Takes one optional argument, a signal name.
