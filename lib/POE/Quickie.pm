...
B<'Context'>, a variable which will be sent back to you with every event.
...
=item C<ARG0>: the line of STDOUT generated by the program
...
=item C<ARG0>: the line of STDERR generated by the program
